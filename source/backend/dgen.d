...
class DGenerator : ASTVisitor
{
	...
	override void visit(const FunctionCallExpression functionCallExpression)
	{
		...
		visit( functionCallExpression.unaryExpression );

		if( functionCallExpression.templateArguments )
		{
			output.write( "!( " );
			visit( functionCallExpression.templateArguments );
			output.write( " )" );
		}
	...
	override void visit(const StatementNoCaseNoDefault statementNoCaseNoDefault)
	{
		...
		statementNoCaseNoDefault.accept( this );
	}
